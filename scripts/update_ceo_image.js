...
const TARGET_ID = 'r4eb8552cc24586'; // CEO Devin
const IMAGE_PATH = '/Users/pondokit/.gemini/antigravity-ide/brain/8bed539f-a3d8-4eb2-9cc1-8cdfe1951c26/media__1780127676062.png';

async function updateCeoImage() {
  ...
  try {
    ...
    form.append('image', blob, `ceo-cognition.png`);
