...
const TARGET_ID = 'rcce3ec81bd7797'; // Opus 4.8
const IMAGE_PATH = '/Users/pondokit/.gemini/antigravity-ide/brain/8bed539f-a3d8-4eb2-9cc1-8cdfe1951c26/media__1780128156043.png';

async function updateOpusImage() {
  ...
  try {
    ...
    form.append('image', blob, `opus-4-8.png`);
