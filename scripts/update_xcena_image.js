...
const TARGET_ID = 'r083750aadef53f'; // XCENA
const IMAGE_PATH = '/Users/pondokit/.gemini/antigravity-ide/brain/8bed539f-a3d8-4eb2-9cc1-8cdfe1951c26/media__1780127762285.png';

async function updateXcenaImage() {
  ...
  try {
    ...
    form.append('image', blob, `xcena.png`);
