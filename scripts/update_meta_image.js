...
const TARGET_ID = 'rfed1f3650bb08e'; // Meta Pendant
const IMAGE_PATH = '/Users/pondokit/.gemini/antigravity-ide/brain/2caf3b19-41d4-409b-8bfd-39adbcc37280/media__1780188020186.png';
...
async function updateMetaImage() {
  ...
  try {
    ...
    form.append('image', blob, `meta-pendant.png`);
